	...
	// Contact Form Handler
		$(document).ready(function() {
			$('#contactForm').on('submit', function(event) {
				...
				// Create mailto link
				var mailtoLink = 'mailto:matthew.thaokhamlue@gmail.com?subject=' + 
				...
				try {
					...
					showContactMessage('Unable to open email client. Please email matthew.thaokhamlue@gmail.com directly.', 'error');
				}
			});
		});
		...
		function showContactMessage(message, type) {
			...
			$note.removeClass('success error').addClass(type);
			$note.text(message);
			$note.show();
